        ...
        <div class="card">
            <div class="card-header">
                <div class="font-16 text-bold-2 text-danger">
                    ویرایش اطلاعات مدیر : <span class="font-16 text-bold-3 text-dark">{{form.name}}</span>
...
export default {
    ...
    methods : {
        GetItem(){
            axios.get('/api/manage/users/managers/' + this.$route.params.id).then(response =>{
        ...
        FormSubmit(){
            ...
            axios.post('/api/manage/users/managers/edit/'+this.$route.params.id,this.form).then(response=>{
