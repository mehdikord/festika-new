        ...
        <div class="card">
            <div class="card-header">
                <div class="font-16 text-bold-2 text-danger">
                    ویرایش اطلاعات کاربر : <span class="font-16 text-bold-3 text-dark">{{form.name}}</span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-4">
                        <div class="form-group">
                            ...
                            <img v-else src="/management/images/no-photo.png" width="70" height="70" alt="">
                        </div>
                    </div>
...
export default {
    ...
    methods : {
        GetItem(){
            axios.get('/api/manage/users/members/' + this.$route.params.id).then(response =>{
        ...
        FormSubmit(){
            ...
            axios.post('/api/manage/users/members/edit/'+this.$route.params.id,this.form).then(response=>{
                this.$router.push({name : 'manage_users_members'});
